...
class pix2pixCmodel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--noise_end_epoch', type=int, default=300, help='end epoch for noise')
            parser.add_argument('--noise_level', type=float, default=0.14, help='noise level')
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_GAN', 'G_L1', 'D_real', 'D_fake', 'D_fake_acc', 'D_real_acc', 'G_classifier']
    ...
    def backward_G(self, epoch):
        ...
        self.loss_G =  self.loss_G_L1 + self.loss_G_GAN + self.loss_G_classifier 
    ...
    def optimize_parameters(self, epoch):
        ...
        if epoch < self.opt.noise_end_epoch: 
            noise = self.opt.noise_level * (1-epoch/self.opt.noise_end_epoch) 
        else:
            noise = 0
         
        self.backward_D(noise)                # calculate gradients for D
